...
| Setting | Value |
|---------|-------|
| Model (external) | Haiku (fast, cheap) |
| Model (Anthropic internal) | Inherit (main model) |
| Min queries before use | 3 (simple search first) |
| Omits CLAUDE.md | Yes (main agent has full context) |
